...
const Features2 = dynamic(() => import('../featureSection').then(mod => mod.Features2), {
  ssr: false
});
      ...
      <div className="text-white">
        <div className="text-center">
          ...
          <p className="mx-auto mb-12 max-w-[68rem] text-lg text-primary-text md:mb-7 md:text-xl">
            ...
            communication, ensuring efficiency and seamless workflow
            integration.
          </p>
        </div>
          ...
          <div className="flex snap-x snap-mandatory gap-6 overflow-x-auto px-8 pb-12 md:flex-wrap md:overflow-hidden">
            <div className="relative flex min-h-[48rem] w-full shrink-0 snap-center flex-col items-center justify-end overflow-hidden rounded-[4.8rem] border border-transparent-white bg-glass-gradient p-8 text-center md:max-w-[calc(66.66%-12px)] md:basis-[calc(66.66%-12px)] md:p-14">
              ...
              <p className="mx-auto mb-12 max-w-[68rem] text-lg text-primary-text md:mb-7 md:text-xl">
                ...
                frontline teams. It offers easy shift scheduling, allowing
                managers to assign shifts while employees can swap or request
                changes effortlessly. The time clock feature enables accurate
                clock-ins and outs, while real-time communication keeps teams
                connected. With deep integration into productivity tools, Taskly
                enhances efficiency by syncing schedules and streamlining
                workflows, making it an essential solution for workforce
                management.
              </p>
            </div>
